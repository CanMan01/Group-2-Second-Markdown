...
Start of Second Markdown Project Answers:

# The Monty Hall Problem: What is it?



![That popular game show from the 70's](C:/Users/doibl/Desktop/Pictures/Second Markdown Photos/Monty Hall Lets make a deal.jpg)


The Monty Hall problem comes from the game show "Let's make a Deal."



![](C:/Users/doibl/Desktop/Pictures/Second Markdown Photos/montyhallproblem.jpeg)

A contestant is given 3 doors to pick from, one of which has a car behind it as the grand prize. The other two doors are duds.
...
Then, the host would open one of the dud doors and ask the contestant whether he/she wants to switch. Since probability isn't subtracted when that door is open, that means that the remaining door has a 2/3 chance of winning the car, since the remaining probability falls on that lone door.
...
This problem plays with your mind because you start to doubt your choice. As you pick a door, you might be uncertain of its outcome, yet also put some faith and trust in that outcome. The opening of the dud door and the question of switching your choice at the last minute places much doubt, and makes people unsure of whether they should go with their choice.
I think its a good way to spice up normal game shows because it shows how one plays with the mind and plays with the chances of probability.
